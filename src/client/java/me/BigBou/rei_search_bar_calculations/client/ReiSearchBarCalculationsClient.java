...
public class ReiSearchBarCalculationsClient implements ClientModInitializer {
    ...
    private static int xPositionOffset = MyConfig.HANDLER.defaults().xOffset;
    private static int yPositionOffset = MyConfig.HANDLER.defaults().yOffset;
        ...
        return YetAnotherConfigLib.createBuilder()
                ...
                .category(ConfigCategory.createBuilder()
                        ...
                        .option(Option.<Integer>createBuilder()
                                ...
                                .binding(0, () -> xPositionOffset, val -> xPositionOffset = val)
                        ...
                        .option(Option.<Integer>createBuilder()
                                ...
                                .binding(0, () -> yPositionOffset, val -> yPositionOffset = val)
                                .controller(opt -> IntegerSliderControllerBuilder.create(opt)
                                        .range(-400, 400)
                                        .step(1))
                                .build())
        ...
        ScreenEvents.BEFORE_INIT.register((client, screen, sw, sh) -> {
            if (screen instanceof HandledScreen<?> handled) {
                ScreenEvents.afterRender(screen).register((scr, context, mouseX, mouseY, delta) -> {
                    ...
                    int textPosX = centerX - 94 + xPositionOffset;
                    int textPosY = bottomY - 32 - yPositionOffset;
